...
if(isset($_POST["insert"])){
    mysqli_query($Link , "insert into it_students values(NULL,'$_POST[registerno]','$_POST[stdname]','$_POST[phno]','$_POST[email]','$_POST[cpyname]','$_POST[location]')");
    header('Location:data_dis_it_page.php');
...
if(isset($_POST["delete"])){
    mysqli_query($Link , "delete from it_students where registerno='$_POST[registerno]'") or die(mysqli_error($Link));
    header('Location:data_dis_it_page.php');
...
if(isset($_POST["update"])){
    mysqli_query($Link,"update it_students set cpyname='$_POST[cpyname]',location='$_POST[location]' where registerno='$_POST[registerno]'") or die(mysqli_error($Link));
    header('Location:data_dis_it_page.php');
