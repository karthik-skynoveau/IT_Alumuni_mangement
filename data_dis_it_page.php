...
<body>
    <div class="dis_container">
        ...
        <p class="dep_title">
            IT DEPARTMENT ALUMINI STUDENTS DETAILS
        </p>

        <div class="update_button_contaniner">

            <a href="./mnc_data_dis_it_page.php" style="margin-right:20px"><button>MNC Placed students</button></a>
            <a href="./admin_login/login.php"><button>Admin</button></a>
        ...
        <div class="server_data">
            ...
            <table class="db_tabel_main_it">
                ...
                <?php
                  $res=mysqli_query($Link,"select * from it_students");
